...
if ( !class_exists('Puc_v4p3_UpdateChecker', false) ):

	abstract class Puc_v4p3_UpdateChecker {
		...
		/**
		 * @var Puc_v4p3_Scheduler
		 */
		public $scheduler;

		/**
		 * @var Puc_v4p3_UpgraderStatus
		 */
		protected $upgraderStatus;

		/**
		 * @var Puc_v4p3_StateStore
		 */
		...
		public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '') {
			...
			$this->upgraderStatus = new Puc_v4p3_UpgraderStatus();
			$this->updateState = new Puc_v4p3_StateStore($this->optionName);
		 ...
		 *
		 * @return Puc_v4p3_Update An instance of Update, or NULL when no updates are available.
		 */
		 ...
		 * @return array [Puc_v4p3_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
		 */
		...
		protected function createDebugBarExtension() {
			return new Puc_v4p3_DebugBar_Extension($this);
		}

		/**
		 * Display additional configuration details in the Debug Bar panel.
		 *
		 * @param Puc_v4p3_DebugBar_Panel $panel
		 */
