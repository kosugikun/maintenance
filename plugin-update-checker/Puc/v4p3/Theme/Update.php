...
if ( !class_exists('Puc_v4p3_Theme_Update', false) ):

	class Puc_v4p3_Theme_Update extends Puc_v4p3_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|Puc_v4p3_Theme_Update $object The source object.
		 * @return Puc_v4p3_Theme_Update The new copy.
		 */
