...
if ( !class_exists('Puc_v4p3_Theme_UpdateChecker', false) ):

	class Puc_v4p3_Theme_UpdateChecker extends Puc_v4p3_UpdateChecker {
		 ...
		 *
		 * @return Puc_v4p3_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('Puc_v4p3_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var Puc_v4p3_Theme_Update $themeUpdate */
		...
		protected function createScheduler($checkPeriod) {
			return new Puc_v4p3_Scheduler($this, $checkPeriod, array('load-themes.php'));
		}
		...
		protected function createDebugBarExtension() {
			return new Puc_v4p3_DebugBar_Extension($this, 'Puc_v4p3_DebugBar_ThemePanel');
		}
