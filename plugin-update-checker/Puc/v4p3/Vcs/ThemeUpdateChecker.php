...
if ( !class_exists('Puc_v4p3_Vcs_ThemeUpdateChecker', false) ):

	class Puc_v4p3_Vcs_ThemeUpdateChecker extends Puc_v4p3_Theme_UpdateChecker implements Puc_v4p3_Vcs_BaseChecker {
		/**
		...
		/**
		 * @var Puc_v4p3_Vcs_Api Repository API client.
		 */
		protected $api = null;

		/**
		 * Puc_v4p3_Vcs_ThemeUpdateChecker constructor.
		 *
		 * @param Puc_v4p3_Vcs_Api $api
		...
		public function requestUpdate() {
			...
			$update->version = Puc_v4p3_Utils::findNotEmpty(array(
				$remoteHeader['Version'],
				Puc_v4p3_Utils::get($updateSource, 'version'),
			));

			//The details URL defaults to the Theme URI header or the repository URL.
			$update->details_url = Puc_v4p3_Utils::findNotEmpty(array(
