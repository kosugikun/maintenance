<?php
if ( !class_exists('Puc_v4p3_Vcs_PluginUpdateChecker') ):

	class Puc_v4p3_Vcs_PluginUpdateChecker extends Puc_v4p3_Plugin_UpdateChecker implements Puc_v4p3_Vcs_BaseChecker {
		/**
		...
		/**
		 * Puc_v4p3_Vcs_PluginUpdateChecker constructor.
		 *
		 ...
		 * @param Puc_v4p3_Plugin_Info $pluginInfo
		 */
